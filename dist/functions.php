...
add_filter('the_content', function($content) {
    if ( is_single() || is_page() ) {
        ...
        $content = str_replace('src="https://design-tomato.com/', 'data-src="https://design-tomato.com/', $content);
        return $content;
    };
});
...
function pagination($pages, $paged, $range = 2, $show_only = true)
{
    ...
    if ($show_only && $pages === 1) {
        echo '<div id="js-pagination" class="p-pagination"><p class="active">1</p></div>';
        return;
    }
    ...
    //２ページ以上の時
    if (1 !== $pages) {
        echo '<div id="js-pagination" class="p-pagination">';
